...
export function verifyOfficeFile(buffer, kind) {
  ...
  let at=start,expanded=0;const names=new Set(),decoder=new TextDecoder('utf-8',{fatal:true});
  ...
  return {kind,entries:count,expandedBytes:expanded};
}
