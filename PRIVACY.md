...
Attachment checkboxes filter the exported copy after capture; they do not prevent retrieval or preview navigation. Embedded document images follow their parent document rather than the separate conversation-image toggle. Exact-text redaction omits slide previews and embedded images and redacts supported document text. Common text/source files are decoded locally (UTF-8, or BOM-marked UTF-16); their contents are never executed.
